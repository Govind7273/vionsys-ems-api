...
exports.createLeaveRequest = async (req, res) => {
  try {
    ...
    if (
      new Date(leaveData?.leaveStart) < new Date(currentDay) ||
      new Date(leaveData?.leaveEnd) < new Date(currentDay)
    ) {
      console.log(leaveData?.leaveStart, leaveData?.leaveEnd, currentDay)
